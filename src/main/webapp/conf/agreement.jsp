...
<script>
	function check() {
		if(document.agr.box1.checked!==true || document.agr.box2.checked!==true) {
			alert("필수 항목 체크를 해주세요.");
			return false;
		}
		  document.agr.submit();
	}
...
<body>
	<div class="container">
		...
		<div class="session">
				<h2 style="margin: 20px">회원가입 약관</h2><br>
			<div class="agrArea">
                <p class="agrTitle">약관동의</p><br>
				<form name="agr" action="../membership/regist.jsp" method="post">	
					<p><input type="checkbox" value="(필수)" name="box1"><b>(필수)</b> 이용약관 </p><br>
					<p><textarea rows="15" cols="120">
제1조(목적)
...
① "몰"이란 에스디미디어 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
1. 이 약관은 년 월 일부터 적용됩니다.
			...
			<p><input type="checkbox" name="box2">
			<b>(필수)</b> 개인정보 수집 및 이용</p> <br>
			<p> <textarea rows="15" cols="120">
...
- 보유 및 이용기간 : 회원탈퇴 후 5일까지
				...
				<div class="nextBtnArea">
					<input type="button" value="다음단계" class="nextBtn" onclick="check()">
					<input type="button" value="취소" class="nextBtn" onclick="history.back()">  
				</div>				
			</form>
		</div>
 	</div>
